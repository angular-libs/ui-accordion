...
angular.module("uiAccordion", []), angular.module("uiAccordion").directive("ngAccordionHeading", function () {
    ...
    return a.prototype.addGroup = function (a) {
        ...
        console.log(a.body[0].innerHTML, a.options.open), a && (a.options.open ? (a.$animate("slideDown", "beforeOpen", "animateOpen"), this.closeOthers(a)) : a.$animate("slideUp", "beforeHide", "animateClose"))
    }, a.prototype.closeOthers = function (a) {
        if (console.log(this.options.closeOthers), this.options.closeOthers)for (var b = 0; b < this.groups.length; b++)a === this.groups[b] || (this.groups[b].options.open = !1, this.groups[b].$animate("slideUp", "beforeHide", "animateClose"), console.log(this.groups[b].body[0].innerHTML, this.groups[b].options.open))
    }, {
